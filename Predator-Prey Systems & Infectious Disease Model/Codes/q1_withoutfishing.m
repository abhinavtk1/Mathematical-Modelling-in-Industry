% Q1 ode45 solver for Lotka-Volterra Model - without fishing
clc;
clear;
...
xlabel('Time');
ylabel('Population');
title('Predator/Prey Populations Over Time without Fishing')
hold off;
...
% Parameters
a = 4; b = 2; c = 1.5; d = 3;
lv(1) = a*x(1) - b*x(1)*x(2); % Rate of change of prey population
lv(2) = c*x(1)*x(2) - d*x(2); % Rate of change of predator population
end