...
n1_dash = n1_dash.subs({k: k_value, c1: c1_value,  d1: d1_value, e1: e1_value})  # Substitute other parameters 
n2_dash = n2_dash.subs({c2: c2_value, d2: d2_value, e2: e2_value, f2: f2_value}) 
n3_dash = n3_dash.subs({c3: c3_value, d3: d3_value, e3: e3_value}) 
n4_dash = n4_dash.subs({c4: c4_value, d4: d4_value})
print("Check point 4")
